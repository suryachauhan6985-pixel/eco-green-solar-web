const CACHE_NAME = 'eco-green-solar-erp-v49';
...
const APP_SHELL = [
  ...
  '/css/style.css?v=38',
  '/css/modules/base.css?v=38',
  '/css/modules/layout.css?v=38',
  '/css/modules/components.css?v=38',
  '/css/modules/dashboard.css?v=38',
  '/css/modules/responsive.css?v=38',
  '/css/modules/party-ledger.css?v=38',
  '/css/modules/auth.css?v=38',
  '/css/modules/bom.css?v=38',
  '/css/modules/scan-sheet.css?v=38',
  '/assets/icon.ico',
  ...
  '/js/pages/bom-kit-helpers.js?v=8',
  '/js/pages/bom-challan.js?v=15',
