const CACHE_NAME = 'eco-green-solar-erp-v59';
...
const APP_SHELL = [
  ...
  '/css/style.css?v=48',
  '/css/modules/base.css?v=48',
  '/css/modules/layout.css?v=48',
  '/css/modules/components.css?v=48',
  '/css/modules/dashboard.css?v=48',
  '/css/modules/responsive.css?v=48',
  '/css/modules/party-ledger.css?v=48',
  '/css/modules/auth.css?v=48',
  '/css/modules/bom.css?v=48',
  '/css/modules/scan-sheet.css?v=48',
  '/assets/icon.ico',
  ...
  '/js/pages/partyledger.js?v=8',
  '/js/pages/lowstock.js?v=4',
  '/js/pages/backup.js?v=3',
  '/js/pages/bom-kit-helpers.js?v=16',
  ...
  '/js/pages/bom-serial-scan.js?v=2',
  '/js/pages/bom-serial-modal.js?v=2',
  '/js/pages/bom-dispatch.js?v=11',
