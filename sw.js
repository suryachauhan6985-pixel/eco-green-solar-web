const CACHE_NAME = 'eco-green-solar-erp-v52';
...
const APP_SHELL = [
  ...
  '/css/style.css?v=41',
  '/css/modules/base.css?v=41',
  '/css/modules/layout.css?v=41',
  '/css/modules/components.css?v=41',
  '/css/modules/dashboard.css?v=41',
  '/css/modules/responsive.css?v=41',
  '/css/modules/party-ledger.css?v=41',
  '/css/modules/auth.css?v=41',
  '/css/modules/bom.css?v=41',
  '/css/modules/scan-sheet.css?v=41',
  '/assets/icon.ico',
  ...
  '/js/pages/bom-kit-helpers.js?v=11',
  '/js/pages/bom-challan.js?v=18',
