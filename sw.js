const CACHE_NAME = 'eco-green-solar-erp-v48';
...
const APP_SHELL = [
  ...
  '/css/style.css?v=37',
  '/css/modules/base.css?v=37',
  '/css/modules/layout.css?v=37',
  '/css/modules/components.css?v=37',
  '/css/modules/dashboard.css?v=37',
  '/css/modules/responsive.css?v=37',
  '/css/modules/party-ledger.css?v=37',
  '/css/modules/auth.css?v=37',
  '/css/modules/bom.css?v=37',
  '/css/modules/scan-sheet.css?v=37',
  '/assets/icon.ico',
  ...
  '/js/pages/bom-kit-helpers.js?v=7',
  '/js/pages/bom-challan.js?v=14',
