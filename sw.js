const CACHE_NAME = 'eco-green-solar-erp-v55';
...
const APP_SHELL = [
  ...
  '/css/style.css?v=44',
  '/css/modules/base.css?v=44',
  '/css/modules/layout.css?v=44',
  '/css/modules/components.css?v=44',
  '/css/modules/dashboard.css?v=44',
  '/css/modules/responsive.css?v=44',
  '/css/modules/party-ledger.css?v=44',
  '/css/modules/auth.css?v=44',
  '/css/modules/bom.css?v=44',
  '/css/modules/scan-sheet.css?v=44',
  '/assets/icon.ico',
  ...
  '/js/pages/bom-kit-helpers.js?v=14',
  '/js/pages/bom-challan.js?v=21',
