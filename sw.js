const CACHE_NAME = 'eco-green-solar-erp-v51';
...
const APP_SHELL = [
  ...
  '/css/style.css?v=40',
  '/css/modules/base.css?v=40',
  '/css/modules/layout.css?v=40',
  '/css/modules/components.css?v=40',
  '/css/modules/dashboard.css?v=40',
  '/css/modules/responsive.css?v=40',
  '/css/modules/party-ledger.css?v=40',
  '/css/modules/auth.css?v=40',
  '/css/modules/bom.css?v=40',
  '/css/modules/scan-sheet.css?v=40',
  '/assets/icon.ico',
  ...
  '/js/pages/bom-kit-helpers.js?v=10',
  '/js/pages/bom-challan.js?v=17',
