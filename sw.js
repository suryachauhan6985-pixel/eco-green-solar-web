const CACHE_NAME = 'eco-green-solar-erp-v50';
...
const APP_SHELL = [
  ...
  '/css/style.css?v=39',
  '/css/modules/base.css?v=39',
  '/css/modules/layout.css?v=39',
  '/css/modules/components.css?v=39',
  '/css/modules/dashboard.css?v=39',
  '/css/modules/responsive.css?v=39',
  '/css/modules/party-ledger.css?v=39',
  '/css/modules/auth.css?v=39',
  '/css/modules/bom.css?v=39',
  '/css/modules/scan-sheet.css?v=39',
  '/assets/icon.ico',
  ...
  '/js/pages/bom-kit-helpers.js?v=9',
  '/js/pages/bom-challan.js?v=16',
