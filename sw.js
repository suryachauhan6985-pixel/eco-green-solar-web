const CACHE_NAME = 'eco-green-solar-erp-v195';
...
const APP_SHELL = [
  ...
  '/js/pages/bom-kit-helpers.js?v=195',
  '/js/pages/bom-challan.js?v=195',
  '/js/pages/bom-challan-map.js?v=195',
  '/js/pages/bom-party-autocomplete.js?v=195',
  '/js/pages/bom-track-register.js?v=195',
  '/js/pages/bom-kit-builder.js?v=195',
  '/js/pages/bom-serial-scan.js?v=195',
  '/js/pages/bom-serial-modal.js?v=195',
  '/js/pages/bom-dispatch.js?v=195',
  '/js/pages/bom.js?v=195',
  '/js/utils/password-policy.js?v=195',
  '/js/core/ui-feedback.js?v=195',
  '/js/core/pwa-permissions.js?v=195',
  '/js/core/auth-session.js?v=195',
  '/js/core/settings-panel.js?v=195',
  '/js/core/navigation-engine.js?v=195',
  '/js/app.js?v=195',
  '/js/theme.js?v=195'
];
