const CACHE_NAME = 'eco-green-solar-erp-v54';
...
const APP_SHELL = [
  ...
  '/css/style.css?v=43',
  '/css/modules/base.css?v=43',
  '/css/modules/layout.css?v=43',
  '/css/modules/components.css?v=43',
  '/css/modules/dashboard.css?v=43',
  '/css/modules/responsive.css?v=43',
  '/css/modules/party-ledger.css?v=43',
  '/css/modules/auth.css?v=43',
  '/css/modules/bom.css?v=43',
  '/css/modules/scan-sheet.css?v=43',
  '/assets/icon.ico',
  ...
  '/js/pages/bom-kit-helpers.js?v=13',
  '/js/pages/bom-challan.js?v=20',
