const CACHE_NAME = 'eco-green-solar-erp-v53';
...
const APP_SHELL = [
  ...
  '/css/style.css?v=42',
  '/css/modules/base.css?v=42',
  '/css/modules/layout.css?v=42',
  '/css/modules/components.css?v=42',
  '/css/modules/dashboard.css?v=42',
  '/css/modules/responsive.css?v=42',
  '/css/modules/party-ledger.css?v=42',
  '/css/modules/auth.css?v=42',
  '/css/modules/bom.css?v=42',
  '/css/modules/scan-sheet.css?v=42',
  '/assets/icon.ico',
  ...
  '/js/pages/bom-kit-helpers.js?v=12',
  '/js/pages/bom-challan.js?v=19',
