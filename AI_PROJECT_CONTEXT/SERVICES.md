...
| --- | --- | --- | --- |
| api/services/challanPdf.js | runSoffice, normalizeBorderSide, applySheetStructure, applySheetFormatting, fillTemplateAndConvertToPdf, cleanup |  | Implements business logic as a service layer. |
