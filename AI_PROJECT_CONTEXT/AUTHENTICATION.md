...
| POST | /api/purchase | api/routes/purchase.route.js |
| DELETE | /api/purchase/:invoiceNo | api/routes/purchase.js |
| DELETE | /api/purchase/:invoiceNo | api/routes/purchase.route.js |
| PUT | /api/purchase/:invoiceNo | api/routes/purchase.js |
| PUT | /api/purchase/:invoiceNo | api/routes/purchase.route.js |
| GET | /api/purchase/brands/:category | api/routes/purchase.js |
| GET | /api/purchase/brands/:category | api/routes/purchase.route.js |
| GET | /api/purchase/check-serials | api/routes/purchase.js |
| GET | /api/purchase/check-serials | api/routes/purchase.route.js |
| GET | /api/purchase/find | api/routes/purchase.js |
| GET | /api/purchase/find | api/routes/purchase.route.js |
| GET | /api/purchase/register | api/routes/purchase.js |
| GET | /api/purchase/register | api/routes/purchase.route.js |
| GET | /api/purchase/wattages | api/routes/purchase.js |
| GET | /api/purchase/wattages | api/routes/purchase.route.js |
