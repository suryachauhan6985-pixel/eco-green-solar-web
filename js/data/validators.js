...
// -----------------------------------------------------------------------------
// Pure offline client-side validation utilities for Indian GSTIN & Mobile Numbers.
// Zero external API calls, instant 0ms feedback, 100% free and robust.
// -----------------------------------------------------------------------------
...
(function (global) {
  ...
  global.EgsValidators = EgsValidators;
  global.normalizeGstin = normalizeGstin;
  global.calculateGstinChecksum = calculateGstinChecksum;
  global.getGstinStateName = getGstinStateName;
  global.validateGstin = validateGstin;
  global.normalizeMobile = normalizeMobile;
  global.validateMobile = validateMobile;
